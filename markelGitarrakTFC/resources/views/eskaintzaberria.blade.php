...
<head>
    ...
    <link rel="icon" href="{{ asset('storage/icon/logo.png') }}">
...
<body class="antialiased">
    @include('navbar')
    <h1>Eskaintza berri bat sortu</h1>
    <div class="container">
        <form method="post" action="sortueskaintza">
            {{ csrf_field() }}
            <label>Eskaintzaren izenburua</label>
            <input required type="text" name="izena">
            ...
            <select required name="egoera">
                ...
                <option value="ia_berria">Ia berria</option>
                <option value="erabilia">Erabilia</option>
                <option value="txarra">Txarra</option>
                <option value="apurtuta">Apurtuta</option>
            </select>

            <label>Argazkiak</label>
            <input style="display: none;" type="text" name="argazkiak" id="input_argazkiak">
            <div class="argazkiak">
